...
if __name__ == "__main__":
    ...
    parser.add_argument("--source_path", type=str, default="datasets/cambridge/ShopFacade")
    parser.add_argument("--images", type=str, default="")
    parser.add_argument("--longest_edge", type=int, default=1920)
    ...
    for key in tqdm(cam_extrinsics, desc="Prepocessing"):
        ...
        pattern = os.path.join(args.source_path, args.images, f"{base_name}.png")
